        ...
        <div class="nav">
            <ul>
                <li class="index"><a href="index.htm">Home</a></li>
                  ...
                  <li class="login"><a href="login.htm" class="active">Login</a></li>
                  <li class="registration"><a href="registration.htm">Registration</a></li>
            </ul>
            <br>
            <br>
            <h3>Enter Username and Password to Login!<br></h3>
            <div class="logindiv">
                ...
                <br>
                 <p3 class="submit"><input type="submit" name="commit" value="Login"></p3>
                </form>
        </div>
